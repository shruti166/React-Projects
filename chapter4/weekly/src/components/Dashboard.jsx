...
export default function Dashboard() {
  ...
  <div style = {{display: "flex", justifyContent: "space-evenly", backgroundColor: "black", marginTop: "10px", alignItems : "center"}}>
    
    <Link style={{textDecoration: "none", color : "white", fontFamily: "sans-serif", fontSize: "30px", marginTop: "20px"}} to = "/home">HOME</Link>
    <Link style={{textDecoration: "none", color : "white", fontFamily: "sans-serif", fontSize: "30px", marginTop: "20px"}}to = "/progress">PROGRESS</Link>
  </div>
  <div style = {{width: "80%", margin: "30px auto"}}>
  <TableContainer >
  <Table variant='striped' colorScheme='purple'>
    <TableCaption>TARGETTED STUDENTS LIST</TableCaption>
    <Thead>
      <Tr>
        <Th>NAME</Th>
        <Th>CLASS</Th>
    ...
    <Tbody>
      <Tr>
        ...
        <Td>7th</Td>
        <Td>CBSE</Td>
        <Td><Checkbox  colorScheme={"green"}>In Progress</Checkbox></Td>
      </Tr>
      <Tr>
        <Td>Akriti</Td>
        <Td>7th</Td>
        <Td>CBSE</Td>
        <Td><Stack spacing={5} direction='row'>
